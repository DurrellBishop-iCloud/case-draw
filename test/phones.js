...
const KEYS = ['phone', 'width', 'length', 'thickness', 'magnetsUp', 'lipDrop', 'lipRaise', 'cutoutEdge', 'cutoutInset', 'cornerRadius', 'cornerProfile', 'cornerProfileY', 'cutouts', 'sideCutouts', 'source'];
